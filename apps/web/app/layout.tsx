        ...
        <AuthProvider>
          <QueryProvider>
            <header className="sticky top-0 z-40 px-3 py-3 md:px-6">
              <div className="top-nav-shell mx-auto flex w-full max-w-[1480px] flex-wrap items-start justify-between gap-2 rounded-2xl border border-slate-600/60 bg-slate-900/55 px-3 py-3 shadow-[0_10px_34px_rgba(2,6,23,0.48)] backdrop-blur-2xl sm:items-center sm:gap-3 sm:px-4">
                <BrandMark />
                <TopNav />
                <HeaderActions />
              </div>
