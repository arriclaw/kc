...
export function BrandMark() {
  return (
    <Link href="/" className="group inline-flex items-center gap-3.5">
      <span className="relative inline-flex h-12 w-12 shrink-0 items-center justify-center overflow-hidden rounded-2xl border border-cyan-300/45 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 shadow-[0_10px_24px_rgba(15,23,42,0.5)]">
